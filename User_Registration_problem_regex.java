...
public class User_Registration_problem_regex {
	      ...
	      public boolean  verifyepassword1 (String pwd_rule1){
		...
		public static void main(String[] args) {
			...
			User_Registration_problem_regex data=new User_Registration_problem_regex();
			...
			System.out.println(data. verifyepassword1(pwd_rule1));
